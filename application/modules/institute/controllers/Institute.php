  ...
  public function staffLogin()
  {
    if (isset($_POST) && !empty($_POST)) {
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        echo json_encode(array('status' => false, 'message' => json_encode($errors)));
        die;
      } else {
        ...
        if ($status) {
          ...
          echo json_encode(array('status' => false, 'errormessage' => 'Invalid Phone or Password.'));
          die;
        }
      }
    }
...
<body>
  ...
  public function institute_forgot_password()
  {
    ...
    if (count($assignments)) {
      ...
      curl_close($curl);
      if ($err) {
        echo json_encode(array('status' => false, 'message' => 'Email send failed.Please Try again.'));
        die;
      } else {
        $userData = array(
        ...
        if ($update) {
          echo json_encode(array('status' => true, 'message' => 'Email with new password is sent to your registered Mail ID'));
          die;
        }
      }
    } else {
      echo json_encode(array('status' => false, 'message' => 'User with this email not found..'));
      die;
    }
  }
  ...
  public function delete_student()
  {
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      echo json_encode(array('status' => true, 'message' => 'Deletion Successful'));
      die;
    }
  }
  ...
  public function studentSignup()
  {
    ...
    if ($this->form_validation->run()) {
      ...
      if ($status) {
        ...
        if ($err) {
          echo json_encode(array('status' => false, 'message' => 'Enquiry Submitted successfully !'));
          die;
        } else {
          //Account details
          ...
          if ($this->session->userdata('institute_id')) {
            echo json_encode(array('status' => true, 'message' => 'Lead added successfull !'));
            die;
          } else if (isset($_POST['institute_id'])) {
            echo json_encode(array('status' => true, 'message' => 'Enquiry Submitted successfully . Please check your email inbox/junk/spam folder for more details.'));
            die;
          }
        }
      }
      ...
      echo json_encode(array('status' => 'valid-error', 'message' => $errors));
      die;
    }
  }
  ...
  public function leadAssign()
  {
    ...
    if ($this->institute_model->updateAllData('leads', $where, $data)) {
      ...
      echo json_encode(array('status' => true, 'message' => 'Lead Assigned Successfully !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to assign lead !'));
      die;
    }
  }
  ...
  public function saveLeadSource()
  {
    ...
    if ($this->institute_model->updateAllData('leads', $where, $data)) {
      ...
      echo json_encode(array('status' => false, 'errormessage' => 'Data updation failed !'));
      die;
    }
  }
  ...
  public function change_contacted_medium()
  {
    ...
    if ($this->institute_model->updateAllData('leads', $where, $data)) {
      ...
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to Update !'));
      die;
    }
  }
  ...
  public function delete_leads()
  {
    ...
    if ($this->institute_model->delete_lead($lead_id)) {
      ...
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to Delete !'));
      die;
    }
  }
  ...
  public function admissionDetails()
  {
    ...
    if (isset($_FILES['profileImage']) && $_FILES['profileImage'] != "" && !empty($_FILES['profileImage']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('profile_photo_error', 'Student Photo Upload Failed');
        die;
    ...
    if (isset($_FILES['father_sign']) && $_FILES['father_sign'] != "" && !empty($_FILES['father_sign']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('father_sign_error', 'Father Sign Upload Failed !');
        die;
        redirect(base_url() . 'online-admission/' . $subdomain, 'refresh');
      }
    } else {
    ...
    if (isset($_FILES['student_sign']) && $_FILES['student_sign'] != "" && !empty($_FILES['student_sign']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('student_sign_error', 'Student Sign Upload Failed !');
        die;
        redirect(base_url() . 'online-admission/' . $subdomain, 'refresh');
      }
    } else {
    ...
    if (isset($_FILES['tenth_marksheet']) && $_FILES['tenth_marksheet'] != "" && !empty($_FILES['tenth_marksheet']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('tenth_marksheet_error', 'Tenth Marksheet Upload Failed !');
        die;
        redirect(base_url() . 'online-admission/' . $subdomain, 'refresh');
      }
    } else {
    ...
    if (isset($_FILES['twelth_marksheet']) && $_FILES['twelth_marksheet'] != "" && !empty($_FILES['twelth_marksheet']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('twelth_marksheet_error', 'Twelth Marksheet Upload Failed !');
        die;
        redirect(base_url() . 'online-admission/' . $subdomain, 'refresh');
      }
    } else {
    ...
    if (isset($_FILES['grad_marksheet']) && $_FILES['grad_marksheet'] != "" && !empty($_FILES['grad_marksheet']['name'])) {
      ...
      if ($result) {
        ...
        $this->session->set_flashdata('grad_marksheet_error', 'Graduation Marksheet Upload Failed !');
        die;
        redirect(base_url() . 'online-admission/' . $subdomain, 'refresh');
      }
    } else {
  ...
  public function add_aannouncment()
  {
    ...
    if ($session == true) {
      ...
      echo json_encode(array('status' => true, 'message' => 'Announcment added Successfully'));
      die;
    }
  }
  ...
  public function add_agent_payments()
  {
    ...
    if ($session == true) {
      ...
      if ($_POST['payment_id'] == "" || $_POST['payment_id'] == NULL) {
        ...
        //$last_id = $this->db->last_query();
        if ($status) {
          echo json_encode(array('status' => true, 'message' => 'Payment added Successfully'));
          die;
        }
      } else {
  ...
  public function userAuth()
  {
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (!empty($emailExist)) {
        ...
        echo json_encode(array('otp'=>$otp,'status' => true, 'message' => 'Authentication Successfull'));
      } else {
        echo json_encode(array('status' => false, 'errormessage' => 'Invalid Email or Password.'));
      }
    }
  ...
  public function verify_otp()
  {
    ...
    // $user_otp1 = $_POST['inputOtp1'];
    // $user_otp2 = $_POST['inputOtp2'];
    // $user_otp3 = $_POST['inputOtp3'];
    // $user_otp4 = $_POST['inputOtp4'];
    // $user_otp5 = $_POST['inputOtp5'];
    // $user_otp6 = $_POST['inputOtp6'];
    $user_otp = $_POST['inputOtp1'].$_POST['inputOtp2'].$_POST['inputOtp3'].$_POST['inputOtp4'].$_POST['inputOtp5'].$_POST['inputOtp6'];
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (isset($_FILES['profileImage']) && $_FILES['profileImage'] != "" && !empty($_FILES['profileImage']['name'])) {
        ...
        if ($result) {
          ...
          $insert_array['profileImage'] = "";
        }
      } else {
        if (isset($_POST['old_ProfileImage']) && !empty($_POST['old_ProfileImage'])) {
          $insert_array['profileImage'] = $_POST['old_ProfileImage'];
        } else {
          $insert_array['profileImage'] = "";
        }
      }
      ...
      if (isset($_FILES['landingProfile']) && $_FILES['landingProfile'] != "" && !empty($_FILES['landingProfile']['name'])) {
        $file_orignal_name = $_FILES['landingProfile']['name'];
        $file_orignal_name = str_replace(' ', '-', $file_orignal_name);;
        $path = 'institute/landingProfile/';
        $image_name = time() . uniqid() . $file_orignal_name;
        $input_name = 'landingProfile';
        $result = $this->institute_model->upload_image($path, $image_name, $input_name);
        if ($result) {
          $insert_array['landingProfile'] = $path . $image_name;
        } else {
          $insert_array['landingProfile'] = "";
        }
      } else {
        if (isset($_POST['old_LandingProfile']) && !empty($_POST['old_LandingProfile'])) {
          $insert_array['landingProfile'] = $_POST['old_LandingProfile'];
        } else {
          $insert_array['landingProfile'] = "";
        }
      }
      // $this->dd($insert_array);
      if ($this->institute_model->updateAllData(TBL_INSTITUTE, $where, $insert_array)) {
        ...
        $session_data = array(
          ...
          'profileImage'         => $row[0]->profileImage,
          'landingProfile'         => $row[0]->landingProfile,
        );
        $this->session->set_userdata($session_data);
        echo json_encode(array('status' => true, 'message' => 'Update Successful'));
        die;
      } else {
        echo json_encode(array('status' => false, 'errormessage' => 'Update Failed !'));
        die;
      }
    }
  }
  ...
  public function deleteEnq()
  {
    if (isset($_POST) && !empty($_POST)) {
      ...
      if ($status) {
        ...
        echo json_encode(array('status' => false, 'errormessage' => 'Deletion Failed.'));
        die;
      }
    }
  }
  ...
  public function getStudentData()
  {
    ...
    if ($session == true || $this->session->userdata('is_admin_in')) {
      ...
      if ($merge_data != null) {
        ...
        echo json_encode(array('status' => false, 'errormessage' => 'No Data Found.'));
        die;
      }
    }
  }
  ...
  public function add_package()
  {
    ...
    if ($status) {
      echo json_encode(array('status' => true, 'message' => 'Updation Success.'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Updation Failed.'));
      die;
    }
  }
  ...
  public function edit_fees()
  {
    ...
    if ($course_dur == count($yearly_fees)) {
      ...
      echo json_encode(array('status' => true, 'message' => 'Fees Updated Successfully !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Course Duration and number of yearly fees input field must be same !'));
      die;
    }
  }
  ...
  public function add_student()
  {
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if ($package != $total_fee) {
        echo json_encode(array('status' => false, 'errormessage' => 'Sum of yearly fees and total package must be same !'));
        die;
      }
      ...
      if ($_POST['student_id'] == "" && $_POST['student_id'] == NULL) {
        ...
        if ($checkLimit[0]->institute_allowed_student <= $checkLimit[0]->institute_student_admited) {
          ...
          echo json_encode(array('status' => false, 'errormessage' => 'Limit Reached.'));
          die;
        }
        $check_mobile = $this->institute_model->checkMobile($institute_id, $mobile);
        if ($check_mobile == true) {
          ...
          if ($status) {
            ...
            echo json_encode(array('status' => true, 'message' => 'Insertion Success.'));
            die;
          } else {
            echo json_encode(array('status' => false, 'errormessage' => 'Insertion Failed.'));
            die;
          }
        } else {
          echo json_encode(array('status' => false, 'errormessage' => 'Mobile number allready exists.Please try with another number'));
          die;
        }
      } else {
        $student_id = $_POST['student_id'];
        ...
        if ($status) {
          echo json_encode(array('status' => true, 'message' => 'Updation Successful'));
          die;
        } else {
          echo json_encode(array('status' => false, 'errormessage' => 'Updation Failed.'));
          die;
  ...
  public function add_student_payment()
  {
    ...
    if ($last_paid == $prev_due || $last_paid < $prev_due) {
      ...
      echo json_encode(array('status' => false, 'errormessage' => 'Paying Amount can not be exceeded Due Amount.'));
      die;
    }
  }
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (($_POST['enquiry_id'] == "" && $_POST['enquiry_id'] == NULL)) {
        ...
        if ($status) {
          ...
          echo json_encode(array('status' => true, 'message' => 'Insertion Successful'));
          die;
        } else {
          echo json_encode(array('status' => false, 'errormessage' => 'Insertion Failed.'));
          die;
  ...
  public function add_staff()
  {
    ...
    if (!isset($_POST['employee_id']) || $_POST['employee_id'] == "" || $_POST['employee_id'] == NULL) {
      ...
      if ($total_emp >= $max_emp) {
        echo json_encode(array('status' => false, 'errormessage' => 'Maximum ' . $max_emp . ' number of employee(s) allowed !'));
        die;
      }
    }
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (isset($_FILES['image']) && $_FILES['image'] != "" && !empty($_FILES['image']['name'])) {
        ...
        if ($result) {
          ...
          echo json_encode(array('status' => false, 'message' => 'Employee Photo Upload Failed'));
          die;
        }
      }
        ...
        if ($check_email == true) {
          ...
          if ($check_mobile == true) {
            ...
            if ($status) {
              ...
              echo json_encode(array('status' => false, 'errormessage' => 'Failed to add employee !'));
              die;
            }
          } else {
            echo json_encode(array('status' => false, 'errormessage' => 'Employee with same mobile number already exists !'));
            die;
          }
        } else {
          echo json_encode(array('status' => false, 'errormessage' => 'Employee with same email id already exists !'));
          die;
        }
      } else {
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (isset($_FILES['id_back']) && $_FILES['id_back'] != "" && !empty($_FILES['id_back']['name'])) {
        ...
        if ($result) {
          ...
          echo json_encode(array('status' => false, 'message' => 'Agent ID Upload Failed'));
          die;
        }
      }
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (!isset($_POST['sub_agent_id']) || $_POST['sub_agent_id'] == "" || $_POST['sub_agent_id'] == NULL) {
        ...
        if ($status) {
          ...
          echo json_encode(array('status' => false, 'errormessage' => 'Updation Failed.' . $sub_agent_id));
          die;
        }
      }
    }
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if (isset($_FILES['image']) && $_FILES['image'] != "" && !empty($_FILES['image']['name'])) {
        ...
        if ($result) {
          ...
          echo json_encode(array('status' => false, 'message' => 'Agent Photo Upload Failed'));
          die;
        }
      }
      ...
      if (isset($_FILES['id_back']) && $_FILES['id_back'] != "" && !empty($_FILES['id_back']['name'])) {
        ...
        if ($result) {
          ...
          echo json_encode(array('status' => false, 'message' => 'Back Side of Agent ID Upload Failed'));
          die;
        }
      }
      ...
      if (isset($_FILES['id_front']) && $_FILES['id_front'] != "" && !empty($_FILES['id_front']['name'])) {
        ...
        if ($result) {
          ...
          echo json_encode(array('status' => false, 'message' => 'Front side of Agent ID Upload Failed'));
          die;
        }
      }
      ...
      if ($_POST['agent_id'] == "") {
        ...
        if (count($emailExist) > 0) {
          if ($instituteId == $_SESSION['institute_id']) {
            echo json_encode(array('status' => false, 'errormessage' => 'Email already exists with this Institute.'));
            die;
          } else {
            $mydata = array(
              'agent_id' => $agent_id,
          ...
          if ($status) {
            ...
            echo json_encode(array('status' => true, 'message' => 'Associate Added Successful !'));
            die;
          } else {
            echo json_encode(array('status' => false, 'errormessage' => 'Failed to add Associate!'));
            die;
          }
        }
      } else {
  ...
  public function changes_pass()
  {
    ...
    if (isset($_POST) && !empty($_POST)) {
      ...
      if ($this->form_validation->run() == FALSE) {
        ...
        echo json_encode(array('status' => false, 'errormessage' => 'Failed to change password!'));
        die;
      } else {
        ...
        if ($this->session->userdata('is_institute_in')) {
          ...
          if ($status) {
            ...
            echo json_encode(array('status' => false, 'errormessage' => 'Old password not match.'));
            die;
          }
        }
  ...
  public function changePasswordEmail($toEmail, $subject, $html)
  {
    ...
    curl_close($curl);
    if ($err) {
      return json_encode(array('status' => false, 'message' => 'Email send failed.Please Try again.'));
      die;
    } else {

      return json_encode(array('status' => true, 'message' => 'Email with new password is sent to your registered Mail ID'));
      die;
    }
  }
  ...
  public function delete_institute()
  {
    ...
    if ($status) {
      echo json_encode(array('status' => true, 'message' => 'Institute Deleted Successfully.'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to Delete'));
      die;
  ...
  public function save_documents()
  {
    ...
    if ($avail == true) {
      ...
      if ($status) {
        echo json_encode(array('status' => true, 'message' => 'Details Saved Successfully.'));
        die;
      } else {
        echo json_encode(array('status' => false, 'message' => 'Details Saved Failed.'));
        die;
      }
    } else if ($avail == false) {
      //submit
  ...
  public function approveStudent()
  {
    ...
    if ($status) {
      echo json_encode(array('status' => true, 'message' => 'Student has been Approved !.'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Student Approve Failed !.'));
      die;
    }
  }
  ...
  public function saveDemoForm()
  {
    ...
    if ($this->institute_model->insertData('demo_requests', $data)) {
      ...
      curl_close($ch);
      //echo $response;
      echo json_encode(array('status' => true, 'message' => 'Request submitted Successfully. We will contact you shortly.'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to save request !'));
      die;
    }
  }
  ...
  public function updatetaskstatus()
  {
    ...
    $sts =  $_REQUEST['updateStatus'];
    $update = $this->db->query("UPDATE lead_reminder SET statusId = '" . $sts . "' WHERE reminder_id = '" . $encID . "");
    //  echo $update ;
    //  return response()->json([
    //   'data'=>$update
    //  ]); 
    $code_data = array('statusId' => $sts);
    $this->db->where(array('reminder_id' => $encID));
    $update = $this->db->update('lead_reminder', $code_data);
    if ($update) {
      // Successful update
      $response = array(
        'status' => true,
      ...
      $this->output
        ->set_status_header(200) // Set HTTP status code 200
      ...
      $this->output
        ->set_status_header(400) // Set HTTP status code 400
        ->set_content_type('application/json')
        ->set_output(json_encode($response));
    }
  }

  public function getTasksModal(){
    $encId = $this->input->post('encId');
    $this->db->where('lead_id', $encId);
    // $this->db->where('reminder_date <=', date('Y-m-d'));
    $this->db->order_by('created_at', "DESC");
    $dataReminder = $this->db->get('lead_reminder')->result();
    if( $dataReminder){
      $response = array(
        'data'=> $dataReminder,
        'status' => true,
  ...
  public function save_lead_comment()
  {
    ...
    if ($this->institute_model->insertData('lead_comments', $data)) {
      ...
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to add comment !'));
      die;
    }
  }
  ...
  public function save_lead_academic()
  {
    ...
    if ($this->institute_model->insertData('lead_academics', $data)) {
      echo json_encode(array('status' => true, 'message' => 'Academic details Added Successfully !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to add academic details !'));
      die;
    }
  }
  ...
  public function save_lead_activity()
  {
    ...
    if ($this->institute_model->insertData('lead_activity', $data)) {
      echo json_encode(array('status' => true, 'message' => 'Activity Added Successfully !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to add activity !'));
      die;
    }
  }
  ...
  public function save_reminder()
  {
    ...
    if ($this->institute_model->insertData('lead_reminder', $data)) {
      echo json_encode(array('status' => true, 'message' => 'Reminder Added Successfully !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Failed to add reminder !'));
      die;
    }
  }
  ...
  public function approve_student()
  {
    ...
    if ($status) {
      ...
      echo json_encode(array('status' => true, 'message' => 'Student Approve Success !'));
      die;
    } else {
      echo json_encode(array('status' => false, 'errormessage' => 'Student Approve Failed !'));
      die;
