                        ...
                        <form id="AdminAddNewManager" enctype="multipart/form-data">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input onchange="readURL(this);" type="file" name="image" class="form-control" id="fileUpload">
                                ...
                                <div class="col-lg-3">
                                    <!-- <span class="colon">:</span> -->
                                    <input onchange="readSigURL(this);" type="file" name="sig" class="form-control" id="fileupload1" />
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-3">
                                    <!-- <span class="colon">:</span> -->
                                    <input onchange="readURLProfile(this);" type="file" name="profileImage" class="form-control" id="fileUpload3" />
                                ...
                                <div class="col-lg-3">
                                    <!-- <span class="colon">:</span> -->
                                    <input onchange="readSigURLLanding(this);" type="file" name="landingProfile" class="form-control" id="fileupload4">
