...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bower-components/bootstrap/dist/css/bootstrap.min.css"
        type="text/css" />
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1039156356993959&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>
<style>
.otpbox {
...
<body>
    ...
    <div class="login-container">
        <div class="left">
            ...
            <div class="two">
                ...
                <p class="upp">Respond faster to incoming leads, collaborate with team members, and share prospectus,
                    fees details & applications forms quicker.</p>
            </div>
            ...
            <div class="three">
                ...
                <p class="investp">360°-degree view of admission conversations fees, contacts, associates. Team members
                    can access
            ...
            <div class="four">
                ...
                <p class="downp">Now reduce your burden of fee collection with our fee Management and online receipt
                    features with dyanamic calculation features.</p>
            </div>

        </div>
        <div class="right">
            <center><img src="<?php echo base_url(); ?>assets/dashboard/img/loginlogo.png" width="120%" alt=""
                    class="brand"></center>
            <hr>
            <div class="head">
                <center>
            ...
            <form id="instituteLogin">
                ...
                <br>
                <input type="eamil" name="email" placeholder="Email Address" class="Email_Input"
                    placeholder="Enter your Email Id" required>

                Password <span class="ast" style="color:red;"> * </span>
                <br>
                <input type="password" name="password" class="Email_Input" id="password"
                    ...
                    <div class="frgt_Padd">
                        <div class="row inner-row-ryt-1">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center Login_Ryt_text _mobileFra">
                                <img class="nextynFavLogo"
                                    src="<?php echo base_url(); ?>assets/dashboard/img/loginlogo.png">
                    ...
                    <div class="frgt_Padd">
                        <div class="row inner-row-ryt-1">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center Login_Ryt_text _mobileFra">
                                <img class="nextynFavLogo"
                                    src="<?php echo base_url(); ?>assets/dashboard/img/loginlogo.png">
                                <p class="" style="margin-bottom: 10px">2 Step Verification <br> <small>OTP successfully
                                        sent to your registered Mobile Number <br>& Email-Id. Please enter the
                                        OTP.</small></p>
                                <div id="validation-errorF"></div>
                                <div class="show"></div>
                            </div>
                        ...
                        <form id="OtpForm">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-11 col-lg-10 text-center Login_Email">
                                    ...
                                    <input id='inputOtp1' name='inputOtp1' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" />
                                    <input id='inputOtp2' name='inputOtp2' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" />
                                    <input id='inputOtp3' name='inputOtp3' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" />
                                    <input id='inputOtp4' name='inputOtp4' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" />
                                    <input id='inputOtp5' name='inputOtp5' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" />
                                    <input id='inputOtp6' name='inputOtp6' class="otpbox" type='text' maxLength="1"
                                        autocomplete="off" onkeyup="submitForm(this.value)" />
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="col-6" style="margin-top: 30px">
    ...
    $("#OtpForm").submit(function(e) {
        e.preventDefault();
        if ($('#inputOtp1').val() == "" || $('#inputOtp2').val() == "" || $('#inputOtp3').val() == "" || $(
                '#inputOtp4').val() == "" || $('#inputOtp5').val() == "" || $('#inputOtp6').val() == "") {
            Swal.fire({
                title: "Required!",
